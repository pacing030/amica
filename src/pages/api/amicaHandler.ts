...
// Sub-functions
const handleSSEConnection = (req: NextApiRequest, res: NextApiResponse): void => {
...
// Send immediate first event so proxies/CDNs keep the stream alive
res.write(`data: ${JSON.stringify({ type: "heartbeat", data: "connected" })}\n\n`);

// Keepalive comments to prevent idle timeout through reverse proxies
